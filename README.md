...
- **自定义快捷键**：托盘菜单可选 F6-F12 作为全局录音快捷键
...
2. **开始录音**：点击按钮或按 **F8**（可自定义），听到高音提示，按钮变红闪烁
3. **实时预览**：说话时按钮下方显示部分识别文字
4. **停止录音**：再次点击或按快捷键，听到低音提示，按钮变黄处理中
5. **自动粘贴**：处理完成后文本自动粘贴到当前光标位置，按钮恢复蓝色
6. **取消处理**：处理中点击或按快捷键可取消
7. **移动按钮**：按住拖拽可移动按钮位置
8. **退出**：右键系统托盘图标 → 退出
...
右键托盘图标 → 快捷键 → 选择 F6-F12 中的任意一个。选择后立即生效。
...
| 全局快捷键 | Win32 RegisterHotKey | F6-F12 全局热键 |
